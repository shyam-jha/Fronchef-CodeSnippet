...
const CodeBlock = ({ id, code, language = "jsx" }: { id: string; code: string; language?: string }) => {
    ...
    return (
        <div
            className={`relative flex flex-col mr-4 justify-between border border-zinc-600 bg-zinc-900 lg:max-w-[85%] overflow-hidden mt-5 rounded-lg p-4 text-lg ${isExpanded ? "h-auto" : `h-[${initialHeight}px]`}`}
        >
            <div
                id={id}
